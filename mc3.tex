...
%also cite Rabosky et al Nature communications
...
%
%%%% use rjMCMC or something to distinguish from normal MCMC
...
%% You should also cite, somewhere, some general reversible jump
%% papers, like Green 1995, or Sisson and Fan 200X
...
%% Again, you should use rjMCMC or the like as relevant
%% to distinguish between reversible jump MCMC
%% and standard MCMC

The purpose of the 
rjMCMC 
%% note change to rjMCMC
