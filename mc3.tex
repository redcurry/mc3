...
%
Mixtures of processes are heterogeneous because each process
is modeled independently, with their own parameter values.
%
Therefore, one process may indicate an increase in speciation rate,
while another may indicate a decrease in the same tree (Figure~\ref{fig:tree}).
